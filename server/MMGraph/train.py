...
def loadAdjs(tfids,Kmers):	
    ...
    if os.path.exists(filename):
        ...
        filename = path+"/"+tfids + "_encode_" + strsize + "_" + "adj_jacc" + ext
...
def motif_task(args):
    ...
    one_task(args.hash,Kmers,adjs_0, adjs_1,adjs_2,adj3, idx_train, idx_val, idx_test, idx_all, labels, options, True)
##########################main##############
